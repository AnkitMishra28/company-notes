-- Multi-tenant SaaS Notes Application Database Schema
-- Shared schema with tenant_id approach for data isolation
...
-- Insert test users (these will be created via Supabase Auth)
-- The profiles will be automatically created via triggers when users sign up
